...
# Interactief menu voor serverbeheer via de terminal
def interactive_menu():
    while True:
        ...
        if keuze == "1":
            ...
            servers.append({"naam": naam, "adres": adres})  # Voeg toe aan de lijst
        ...
        # Optie 3: Toon alle geregistreerde servers
            ...
            for server in servers:
                print(f"{server['naam']} - {server['adres']}")
